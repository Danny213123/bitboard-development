...
from chess_constants import Colour, square_map
...
def generate_fen(position) -> str:
    ...
    fen += f" {side_to_move_map[position.colour_to_move]}"

    w_castle_king = position.castle_rights[Colour.WHITE][0] == True
    w_castle_queen = position.castle_rights[Colour.WHITE][1] == True
    b_castle_king = position.castle_rights[Colour.BLACK][0] == True
    b_castle_queen = position.castle_rights[Colour.BLACK][1] == True
